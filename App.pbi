...
Global CodeDB.i,CodeID.i
  ...
  Declare.l Open_Database(DBFileName.s)
...
Module App
  ...
  Procedure.l Open_Database(DBFileName.s)

    ;Build database name
    ;CodeDBName.s = GetCurrentDirectory() + "Database/Code Library.db"
 
    ;Open Main Database
    DBHnd.l = OpenDatabase(#PB_Any,DBFileName, "", "") 
    If DBHnd.l = 0
      MessageRequester("Database Error","Failed to open Code Database!", #PB_MessageRequester_Ok  )
      ProcedureReturn 0
    Else 
