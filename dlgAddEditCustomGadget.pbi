...
DeclareModule AddEditCustomGadget
...
Module AddEditCustomGadget
  
  ;-Include Files
  IncludeFile "DCTool.pbi"
  
Enumeration AddEditApp 300
    #WinAddApp
    #txtTitle
    #strTitle
    #txtCategory
  ...
  Procedure SaveApplication(View.i)
    
    Define Criteria.s,Category.s
    
    Category = Str(GetGadgetItemData(#cmbCategory,GetGadgetState(#cmbCategory)))
    StoreFolder = GetCurrentDirectory() + "Code\Custom Gadgets\" + ReplaceString(GetGadgetText(#strTitle)," ","-")
    ...
    Else
      ...
      Criteria = Criteria + " 3," + Category + ",'" + PathToApplication + "','" + StoreFolder + "','"
  ...
  Procedure Open(View.i)
    ...
    OpenWindow(#WinAddApp, 0, 0, 690, 180, "Custom Gadget", #PB_Window_SystemMenu| #PB_Window_ScreenCentered)
