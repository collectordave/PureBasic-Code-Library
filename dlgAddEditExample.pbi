...
Module AddEditExample
  
  ;-Include Files
  IncludeFile "DCTool.pbi"
  
  Enumeration AddEditExample 400
    #WinAddApp
    #txtTitle
    #strTitle
    #txtCategory
  ...
  Procedure SaveApplication(View.i)
    ...
    StoreFolder = GetCurrentDirectory() + "Code\Examples\" + ReplaceString(GetGadgetText(#strTitle)," ","-")
    ...
    Else
      ...
      Criteria = Criteria + " 4," + Category + ",'" + PathToApplication + "','" + StoreFolder + "','"
  ...
  Procedure Open(View.i)
    ...
    OpenWindow(#WinAddApp, 0, 0, 690, 180, "Example", #PB_Window_SystemMenu| #PB_Window_ScreenCentered)
